...
class RedeemResourceIT {
    ...
    @AfterEach
    public void cleanup() {
        if (insertedRedeem != null) {
            redeemRepository.delete(insertedRedeem);
            insertedRedeem = null;
        }
    }
    ...
    void getAllRedeems() throws Exception {
        ...
        insertedRedeem = redeemRepository.save(redeem);
